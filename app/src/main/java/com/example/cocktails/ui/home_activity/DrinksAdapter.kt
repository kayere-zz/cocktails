...
class DrinksAdapter(var drinks: List<Drink>, private val activity: HomeActivity) : RecyclerView.Adapter<DrinksViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DrinksViewHolder =
        DrinksViewHolder(DrinkItemBinding.inflate(LayoutInflater.from(activity)))

    override fun onBindViewHolder(holder: DrinksViewHolder, position: Int) {
        holder.binding.apply {
            materialCardView3.transitionName = "card$position to detail"
